$(document).ready(function() {
  ...
  var ObjectArray = [
    ...
    new QA(
      "How long is the day on the Saturn?",
      "12h 14m",
      "10h 42m",
      "8h 51m",
      "10h 42m"
    ...
    new QA(
      "What is the heaviest object in Solar System?",
      "Sun",
      "Earth",
      "Jupiter",
      "Sun"
    ...
    new QA(
      "Which on is the hottest planet in Solar system?",
      "Mercury",
      "Venus",
      "Mars",
      "Venus"
    ...
    new QA(
      "Which planet in the Solar System has rings surrounding it?",
      "Saturn",
      "Pluto",
      "Mars",
      "Saturn"
    ...
    new QA(
      "Which planet is smaller than the Earth's moon?",
      "Mecury",
      "Mars",
      "Pluto",
      "Pluto"
    ...
    new QA(
      "How many years it takes for Neptune to make one orbit around the Sun?",
      "187.5 yrs",
      "164.7 yrs",
      "123.2 yrs",
      "164.7 yrs"
    ...
    new QA(
      "How long it takes for light from the Sun to travel to Earth?",
      "5.2 min",
      "6.8 min",
      "8.3 min",
      "8.3 min"
  ...
  var ANSWERED = 0,
    NOT_ANSWERED = 0,
    WRONG = 0; //tracking variables for final screen
  ...
  function displayQA(array_Element) {
    ...
    $(".main").append(
      `<input type = 'button' class = 'option' value = '${
        array_Element.option_one
      }'></input>`
    );
    $(".main").append(
      `<input type = 'button' class = 'option' value = '${
        array_Element.option_two
      }'></input>`
    );
    $(".main").append(
      `<input type = 'button' class = 'option' value = '${
        array_Element.option_three
      }'></input>`
    );
  }
  ...
  function displayCorrectAnswer(index) {
    $(".main *").remove();
    $(".main").append(`
    <h2 class = 'answer'>Wrong!</h2>
      <div class = 'answer'>The correct answer was: ${ObjectArray[index].answer}
      </div>`);
  }
  ...
  function finalScreen() {
    ...
    $(".main").append(
      `<div class = 'answer'> Answered Correctly: ${ANSWERED}</div>`
    );
    $(".main").append(`<div class = 'answer'> Answered Wrong: ${WRONG}</div>`);
    $(".main").append(
      `<div class = 'answer'> Didn't answer: ${NOT_ANSWERED}</div>`
    );
    $(".main").append(
      "<input type = 'button' class = 'reset' value = 'Restart'>"
    );
  }
  ...
  $(".main").append(
    `<div id='welcome'>
        ...
        <p>You will be given 10 seconds to answer each question.</p>
        <p>Have fun!</p>
    </div>`
  );

  $(".main").append(
    "<input type = 'button' id = 'start-game' value = 'Start Game'>"
  );
